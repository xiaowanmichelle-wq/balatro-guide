...
const CARD_DATA = {
    ...
    jokers: [
        ...
        { id: "j_dna", image: "https://patchwiki.biligame.com/images/balatro/f/f3/rees1v02ta0b7zyfmyu1g7xoy1sbyy8.png", name: "DNA", rarity: "legendary", type: "joker", effects: { special: "copy" }, tags: ["special", "copy"], description: "如果回合内的第1次出牌只有1张牌，则将其1张复制加入完整牌组中，并将该复制加入手牌", best_with: ["high_card"], synergies: ["j_half", "j_hologram", "j_hanging_chad", "j_hiker", "j_supernova"], synergy_note: "半张小丑出≤3张牌+20倍率 | 全息影像每复制+×0.25倍率 | 未断选票让单牌额外触发2次 | 徒步者反复出同一张单牌永久叠筹码 | 超新星每打高牌+倍率", unlock: "在回合第一手只打出1张牌" },
