...
const CARD_DATA = {
    ...
    jokers: [
        ...
        { id: "j_rocket", image: "https://patchwiki.biligame.com/images/balatro/3/34/segv2a0wf6pcd66woib9n85m6rb6imw.png", name: "火箭", rarity: "uncommon", type: "joker", effects: { economy: 1, economy_boss: 2 }, tags: ["economy", "boss"], description: "回合结束时获得$1，每击败1个boss盲注会这个能力获得的金钱+$2", best_with: ["all"], synergies: ["j_golden", "j_bull", "j_bootstraps"] },
        ...
        { id: "j_constellation", image: "https://patchwiki.biligame.com/images/balatro/8/80/m93qng5jrf8v9ky6pj3fhs011g2xugk.png", name: "星座", rarity: "uncommon", type: "joker", effects: { xmult: "planet" }, tags: ["xmult", "planet"], description: "每使用1张星球牌，这张小丑获得×0.1倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_fortune_teller", "j_astronomer", "j_satellite"] },
        ...
        { id: "j_hiker", image: "https://patchwiki.biligame.com/images/balatro/6/69/me7cjq9mrw2qqc04bz9993m7wjgbt19.png", name: "徒步者", rarity: "uncommon", type: "joker", effects: { chips: "permanent_5" }, tags: ["chips", "permanent"], description: "打出的牌在计分时永久获得+5筹码", best_with: ["all"], synergies: ["j_splash", "j_hanging_chad", "j_dna"], synergy_note: "飞溅让所有打出的牌计分+5筹码 | 未断选票让第1张计分牌额外触发2次，永久+15筹码 | DNA反复出同一张单牌，筹码滚雪球叠加" },
        ...
        { id: "j_vampire", image: "https://patchwiki.biligame.com/images/balatro/2/2f/eqtijo8jnuzlx7vwlx8olix8rf7y5ys.png", name: "吸血鬼", rarity: "uncommon", type: "joker", effects: { xmult: "augment", chance: 0.1 }, tags: ["xmult", "augment"], description: "每打出1张计分的增强游戏牌，这张小丑获得×0.1倍率，并移除游戏牌的增强效果（起始×1倍率）", best_with: ["all"], synergies: ["t_empress", "t_emperor", "j_midas"], synergy_note: "迈达斯面具持续产出金卡供吸血鬼吸收，皇后/皇帝持续创造增强牌供吸血鬼消耗叠倍率" },
        { id: "j_hologram", image: "https://patchwiki.biligame.com/images/balatro/6/65/84em1b6mq32h83v4s4egu9xt5u91oa2.png", name: "全息影像", rarity: "uncommon", type: "joker", effects: { xmult: "card_added", value: 0.25 }, tags: ["xmult", "deck"], description: "每添加1张游戏牌到你的完整牌组中，这个小丑获得×0.25倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_fortune_teller", "j_constellation", "j_dna", "j_certificate", "j_marble"], synergy_note: "占卜师/星座配合塔罗牌/行星牌使用间接加牌；DNA复制单牌加入牌组；证书选盲注时加牌；大理石小丑选盲注时加石头牌，均触发全息+×0.25" },
        ...
        { id: "j_erosion", image: "https://patchwiki.biligame.com/images/balatro/b/b9/qm9atscbtq9q078awsd1iocsfdzq8x8.png", name: "侵蚀", rarity: "uncommon", type: "joker", effects: { mult: "lower_cards" }, tags: ["mult", "deck"], description: "当前的完整牌组数量每比初始的完整牌组数量少1张，这个小丑就获得+4倍率（起始+0倍率）", best_with: ["all"], synergies: ["t_hanged", "s_immolate", "j_sixth_sense", "j_canio"], synergy_note: "倒吊人移除2张牌=+8倍率；火祭摧毁5张牌=+20倍率且获$20；第六感摧毁6减少牌组+4倍率；卡尼奥摧毁人头牌叠X倍率，与侵蚀+倍率双重收益" },
        ...
        { id: "j_stone", image: "https://patchwiki.biligame.com/images/balatro/f/f9/12kdaiabrki0nea23x3bv0sg1zajeog.png", name: "石头小丑", rarity: "uncommon", type: "joker", effects: { chips: "stone" }, tags: ["chips", "stone"], description: "完整牌组内每有1张石头牌，这个小丑牌获得+25筹码（起始+0筹码）", best_with: ["all"], synergies: ["j_marble"] },
        { id: "j_lucky_cat", image: "https://patchwiki.biligame.com/images/balatro/0/00/n12p2x6idikwbdq69hlbwz6yare5nob.png", name: "招财猫", rarity: "uncommon", type: "joker", effects: { xmult: "lucky", value: 0.25 }, tags: ["xmult", "lucky"], description: "每次幸运牌被触发时，这张小丑获得×0.25倍率（起始×1倍率）", best_with: ["all"], synergies: ["t_magician", "j_oops_6"] },
        ...
        { id: "j_flash", image: "https://patchwiki.biligame.com/images/balatro/0/0d/nmdc2mxq87sx1p585nj0dqd87n4baog.png", name: "闪示卡", rarity: "uncommon", type: "joker", effects: { mult: "reroll" }, tags: ["mult", "shop"], description: "每在商店中重掷1次，这个小丑获得+2倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_chaos"] },
        ...
        { id: "j_spare_trousers", image: "https://patchwiki.biligame.com/images/balatro/a/a2/0oeftdb257l6nk8getn12jrch630smg.png", name: "备用裤子", rarity: "uncommon", type: "joker", effects: { mult: "two_pair" }, tags: ["mult", "hand"], hand: "two_pair", description: "如果打出的牌包含两对，这个小丑获得+2倍率（起始+0倍率）", best_with: ["two_pair"], synergies: ["j_mad", "j_clever", "j_jolly", "j_four_fingers", "j_square", "j_duo"], synergy_note: "疯狂小丑+10倍率、聪敏小丑+80筹码，两对核心三件套；开心小丑对子也在两对内触发；四指降低组牌门槛；二重奏×2倍率在打两对时也会触发" },
        ...
        { id: "j_ramen", image: "https://patchwiki.biligame.com/images/balatro/f/f6/jdfe5s4i7vlw5hi425fb80phj0x2e2f.png", name: "拉面", rarity: "uncommon", type: "joker", effects: { xmult: 2, mult_neg: "discard" }, tags: ["xmult", "discard"], description: "×2倍率，每弃1张牌失去×0.01倍率", best_with: ["all"], synergies: ["j_burglar"], synergy_note: "窃贼移除所有弃牌次数，使拉面保持满倍率" },
        ...
        { id: "j_throwback", image: "https://patchwiki.biligame.com/images/balatro/4/4e/1r4xoa54zwfs2ejf2nlyz61qst8xsvk.png", name: "回溯", rarity: "uncommon", type: "joker", effects: { xmult: "skip", value: 0.25 }, tags: ["xmult", "skip"], description: "本赛局每跳过1次盲注，这个小丑获得×0.25倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_red"], unlock: "从主菜单继续一局游戏" },
        ...
        { id: "j_wee", image: "https://patchwiki.biligame.com/images/balatro/6/62/ckzkxdjcrb2bzd4qt6g5xxadca57lvm.png", name: "小小丑", rarity: "rare", type: "joker", effects: { chips: 8, rank: [2] }, tags: ["chips", "rank", "rescore"], description: "打出的2在计分时使这个小丑获得+8筹码（起始+0筹码）", best_with: ["all"], synergies: ["j_hanging_chad", "j_fibonacci", "j_even_steven", "j_hack", "j_ride_bus"], synergy_note: "未断选票重复触发；斐波那契2+8倍率叠加；偶数史蒂文2+4倍率叠加；烂脱口秀演员重置2反复计分 | 搭乘巴士鼓励只打数字牌，2是最小的数字牌" },
        ...
        { id: "j_satellite", image: "https://patchwiki.biligame.com/images/balatro/0/02/s0nxq1tk8sprjexsr15y8gi4q8ksgzm.png", name: "卫星", rarity: "uncommon", type: "joker", effects: { economy: "unique_planet" }, tags: ["economy", "planet"], description: "本赛局每使用过1种星球牌，回合结束时就获得$1（起始$0）", best_with: ["all"], synergies: ["j_astronomer", "j_constellation", "j_bull", "j_bootstraps"], synergy_note: "天文学家让行星牌免费，卫星每种独特行星+$1，免费拿行星快速叠收入 | 星座每用行星+×0.1倍率 | 斗牛/提靴带把卫星赚的钱转筹码/倍率" },
