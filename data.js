...
const CARD_DATA = {
    ...
    jokers: [
        ...
        { id: "j_devious", image: "https://patchwiki.biligame.com/images/balatro/8/8f/p7mlrv5ku3e69lmvnbfh9sucooqmfnd.png", name: "阴险小丑", rarity: "common", type: "joker", effects: { chips: 100 }, tags: ["chips", "hand"], hand: "straight", description: "如果打出的牌包含顺子给予+100筹码", best_with: ["straight"], synergies: ["j_crazy", "j_order", "j_runner"] },
        ...
        { id: "j_stencil", image: "https://patchwiki.biligame.com/images/balatro/1/17/l9cl7qfplqquu9j6l9gpbkmspv5drhc.png", name: "模具小丑", rarity: "uncommon", type: "joker", effects: { xmult: "slot" }, tags: ["xmult", "scaling"], description: "每个空的小丑槽位获得×1倍率，模具小丑视为空的小丑槽位", best_with: ["all"], synergies: ["j_madness"] },
        { id: "j_four_fingers", image: "https://patchwiki.biligame.com/images/balatro/7/7d/n6fnqufd693tds7ihc3q8rrgbnqlq6x.png", name: "四指", rarity: "uncommon", type: "joker", effects: { special: "four_fingers" }, tags: ["special", "straight_flush"], description: "同花和顺子都可以由4张牌组成", best_with: ["straight", "flush", "straight_flush"], synergies: ["j_crazy", "j_droll", "j_order", "j_tribe", "j_shortcut", "j_spare_trousers", "j_square"] },
        
        // 斐波那契、奇数托德、偶数史蒂文 - 核心协同组合!
        { id: "j_fibonacci", image: "https://patchwiki.biligame.com/images/balatro/3/3a/toxn01lyfjhw6zmcml8xq23pi6o05k6.png", name: "斐波那契", rarity: "uncommon", type: "joker", effects: { mult: 8, rank: [1, 2, 3, 5, 8] }, tags: ["mult", "rank", "fibonacci"], description: "打出的A、2、3、5、8在计分时给予+8倍率", best_with: ["all"], synergies: ["j_even_steven", "j_odd_todd", "j_hack", "j_scholar", "j_wee", "j_hanging_chad", "j_ride_bus"], synergy_note: "与偶数史蒂文配合：2、8触发双重效果 | 与奇数托德配合：A、3、5触发双重效果 | 小小丑2计分+筹码叠加 | 未断选票让第1张计分牌额外触发2次，+8倍率变+24倍率 | 搭乘巴士鼓励只打数字牌，2/3/5/8全是数字牌" },
        ...
        // J相关
        { id: "j_hit_road", image: "https://patchwiki.biligame.com/images/balatro/9/98/bhnx4iljfqk1f1h67u5ptwxu1etq4cd.png", name: "上路吧杰克", rarity: "rare", type: "joker", effects: { xmult: "discard_j", value: 0.5 }, tags: ["xmult", "rank", "discard", "scaling"], description: "回合中每舍弃1张J，这个小丑获得×0.5倍率，回合结束时重置为起始倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_drunkard", "j_merry_andy"], synergy_note: "醉汉/快乐安迪增加弃牌次数，加速上路吧杰克倍率累积" },
        { id: "j_canio", image: "https://patchwiki.biligame.com/images/balatro/7/71/nsvckiuc1hmattmkxal0z2qrs4bb768.png", name: "卡尼奥", rarity: "legendary", type: "joker", effects: { xmult: "destroy_face" }, tags: ["xmult", "destroy", "face", "scaling"], description: "每当1张人头牌被摧毁时，这个小丑获得×1倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_erosion", "j_glass", "j_sixth_sense"], synergy_note: "侵蚀每减少1张牌+4倍率与卡尼奥双重收益；玻璃小丑的玻璃牌摧毁时可触发卡尼奥（如果是人头牌）；第六感摧毁6点牌减少牌组", unlock: "通过灵魂牌发现" },
        ...
        // 牌型倍率组合
        { id: "j_duo", image: "https://patchwiki.biligame.com/images/balatro/8/8a/3ks8my2xjjnqd35ycva8hb818wtfyed.png", name: "二重奏", rarity: "rare", type: "joker", effects: { xmult: 2, hand: "pair" }, tags: ["xmult", "hand"], description: "如果打出的牌包含对子，则给予×2倍率", best_with: ["one_pair"], synergies: ["j_jolly", "j_sly", "j_mad", "j_clever", "j_spare_trousers"], synergy_note: "两对包含对子，打两对时二重奏×2也会触发；搭配开心+8倍率/奸诈+50筹码/疯狂+10倍率/聪敏+80筹码/备用裤子永久+倍率，组成对子/双对流", unlock: "赢得1局游戏，且未打出对子" },
        { id: "j_trio", image: "https://patchwiki.biligame.com/images/balatro/e/eb/4xqxpbecldizspgovlu5tdtr132ox70.png", name: "三重奏", rarity: "rare", type: "joker", effects: { xmult: 3, hand: "three" }, tags: ["xmult", "hand"], description: "如果打出的牌包含三条，则给予×3倍率", best_with: ["three_of_a_kind"], synergies: ["j_zany", "j_wily", "j_jolly"], synergy_note: "古怪+12倍率/狡猾+100筹码组成三条流；葫芦包含三条+对子，开心小丑对子效果也能触发", unlock: "赢得1局游戏，且未打出三条" },
        { id: "j_family", image: "https://patchwiki.biligame.com/images/balatro/4/41/k3uw3hqr7cj21ej6nk03qyek0gygahf.png", name: "一家人", rarity: "rare", type: "joker", effects: { xmult: 4, hand: "four" }, tags: ["xmult", "hand"], description: "如果打出的牌包含四条，则给予×4倍率", best_with: ["four_of_a_kind"], synergies: ["j_trio"], unlock: "赢得1局游戏，且未打出四条" },
        { id: "j_order", image: "https://patchwiki.biligame.com/images/balatro/c/cc/4oo4dn3pyv959nw5l1a2kjzzdjmu1pd.png", name: "秩序", rarity: "rare", type: "joker", effects: { xmult: 3, hand: "straight" }, tags: ["xmult", "hand"], description: "如果打出的牌包含顺子，则给予×3倍率", best_with: ["straight"], synergies: ["j_crazy"], unlock: "赢得1局游戏，且未打出顺子" },
        { id: "j_tribe", image: "https://patchwiki.biligame.com/images/balatro/e/e0/i57gzzij7kd0dmsu7ofzl26zjpv2tp9.png", name: "部落", rarity: "rare", type: "joker", effects: { xmult: 2, hand: "flush" }, tags: ["xmult", "hand"], description: "如果打出的牌包含同花，则给予×2倍率", best_with: ["flush"], synergies: ["j_droll", "j_smeared", "j_rough_gem"], unlock: "赢得1局游戏，且未打出同花" },
        
        // 花色组合
        { id: "j_flower_pot", image: "https://patchwiki.biligame.com/images/balatro/d/db/azku8xrqf7zl0pih0435ksp4xy1yday.png", name: "花盆", rarity: "uncommon", type: "joker", effects: { xmult: 3, hand: "four_suit" }, tags: ["xmult", "hand"], description: "如果打出的牌型中包含♠♥♣♦花色牌各1张，则给予×3倍率", best_with: ["all"], synergies: ["j_greedy", "j_lusty", "j_wrathful", "j_gluttonous"] },
        { id: "j_blackboard", image: "https://patchwiki.biligame.com/images/balatro/2/25/e8qfv84e7kmm1ughx77kv9zj0yc14ak.png", name: "黑板", rarity: "uncommon", type: "joker", effects: { xmult: 3, suit: ["spades", "clubs"] }, tags: ["xmult", "suit"], description: "如果留在手牌中的牌花色都是或，则给予×3倍率", best_with: ["all"], synergies: ["j_wrathful", "j_gluttonous", "j_arrowhead", "j_onyx"] },
        { id: "j_bloodstone", image: "https://patchwiki.biligame.com/images/balatro/0/0b/5by0c814rvrs5wf1rg3m9zs89pr8vuk.png", name: "血石", rarity: "uncommon", type: "joker", effects: { xmult: 1.5, suit: "hearts", chance: 0.5 }, tags: ["xmult", "suit", "chance"], description: "打出的♥红桃牌在计分时有1/2的概率给予×1.5倍率", best_with: ["flush"], synergies: ["j_lusty", "j_gros_michel", "j_smeared", "j_hanging_chad"], synergy_note: "未断选票让第1张计分牌额外触发2次，多2次机会触发X1.5倍率" },
        { id: "j_arrowhead", image: "https://patchwiki.biligame.com/images/balatro/f/fe/qrnz9huicaxe3c4srbc6iu47h9n8mq1.png", name: "箭头", rarity: "uncommon", type: "joker", effects: { chips: 50, suit: "spades" }, tags: ["chips", "suit"], description: "打出的♠黑桃牌在计分时给予+50筹码", best_with: ["straight", "flush"], synergies: ["j_wrathful", "j_smeared", "j_droll", "j_crafty", "j_hanging_chad"], synergy_note: "箭头黑桃+50筹码，与愤怒小丑同花色协同，模糊小丑扩大触发范围，滑稽/精明同花体系配合 | 未断选票让第1张计分牌额外触发2次，+50筹码变+150筹码", unlock: "牌组中拥有至少30张黑桃" },
        { id: "j_onyx", image: "https://patchwiki.biligame.com/images/balatro/b/b6/j3stvd4iadcz74dpao20x7wqy4dwtd8.png", name: "缟玛瑙", rarity: "uncommon", type: "joker", effects: { mult: 7, suit: "clubs" }, tags: ["mult", "suit"], description: "打出的♣梅花牌在计分时给予+7倍率", best_with: ["flush"], synergies: ["j_gluttonous", "j_blackboard", "j_smeared", "j_hanging_chad"], unlock: "牌组中拥有至少30张梅花" },
        { id: "j_rough_gem", image: "https://patchwiki.biligame.com/images/balatro/8/82/to4w28fzybcjdl1hnw4ilptjnqxz89l.png", name: "璞玉", rarity: "uncommon", type: "joker", effects: { economy: "diamonds", value: 1 }, tags: ["economy", "suit"], description: "打出的♦方块牌在计分时获得$1", best_with: ["flush", "straight_flush"], synergies: ["j_tribe", "j_smeared", "j_greedy", "j_droll", "j_crafty", "j_bull", "j_bootstraps"], synergy_note: "璞玉方块牌+$1，与同花体系（部落/滑稽/精明）配合打同花多方块牌收益最大化，贪婪小丑方块+3倍率同花色协同，模糊小丑扩大方块触发范围" },
        
        // 抽牌/弃牌相关
        { id: "j_burglar", image: "https://patchwiki.biligame.com/images/balatro/1/19/5fagb3seokyc4m0w5a6lnn1qtjve1c8.png", name: "窃贼", rarity: "uncommon", type: "joker", effects: { draw: 3, lose_discards: true }, tags: ["draw", "discard"], description: "选择盲注时，本回合+3出牌次数，并失去所有弃牌次数", best_with: ["all"], synergies: ["j_ramen", "j_mystic_summit", "j_delayed", "j_green", "j_obelisk"], synergy_note: "拉面/绿色小丑不扣倍率，神秘之峰0弃牌+15倍率，延迟满足+$2；方尖石塔：失去弃牌被迫多打非常用牌型，快速叠加X倍率" },
        ...
        { id: "j_merry_andy", image: "https://patchwiki.biligame.com/images/balatro/0/0e/08wbjd3k8koyuqvmdl78rrb58r2x3nj.png", name: "快乐安迪", rarity: "uncommon", type: "joker", effects: { discard: 3, hand_size: -1 }, tags: ["discard", "hand_size"], description: "手牌上限-1，弃牌次数+3", best_with: ["all"], synergies: ["j_yorick", "j_hit_road", "j_banner", "j_burnt"] },
        ...
        { id: "j_rocket", image: "https://patchwiki.biligame.com/images/balatro/3/34/segv2a0wf6pcd66woib9n85m6rb6imw.png", name: "火箭", rarity: "uncommon", type: "joker", effects: { economy: 1, economy_boss: 2 }, tags: ["economy", "boss", "scaling"], description: "回合结束时获得$1，每击败1个boss盲注会这个能力获得的金钱+$2", best_with: ["all"], synergies: ["j_golden", "j_bull", "j_bootstraps"] },
        { id: "j_to_moon", image: "https://patchwiki.biligame.com/images/balatro/1/19/9awaef0twb7rgmlkjhumhoe4zmeizj4.png", name: "冲向月球", rarity: "uncommon", type: "joker", effects: { economy: "interest" }, tags: ["economy", "interest"], description: "回合结束时你每有$5，就获得$1的额外利息（不超过当前利息上限）", best_with: ["all"], synergies: ["j_golden", "j_bull", "j_bootstraps"] },
        
        // 复制类
        { id: "j_blueprint", image: "https://patchwiki.biligame.com/images/balatro/d/d2/gapp8i1mspjudd8304lqi6je4wu9a3v.png", name: "蓝图", rarity: "rare", type: "joker", effects: { special: "copy_right" }, tags: ["special", "copy"], description: "复制右侧小丑牌的能力", best_with: ["all"], synergies: ["j_brainstorm"], unlock: "赢得1局游戏" },
        { id: "j_brainstorm", image: "https://patchwiki.biligame.com/images/balatro/9/97/6td17kusye90w228dlwevrmn18lvjs7.png", name: "头脑风暴", rarity: "rare", type: "joker", effects: { special: "copy_left" }, tags: ["special", "copy"], description: "复制最左侧小丑牌的能力", best_with: ["all"], synergies: ["j_blueprint"], unlock: "弃掉1副皇家同花顺" },
        
        // 抽象/计数类
        { id: "j_abstract", image: "https://patchwiki.biligame.com/images/balatro/b/b1/50llmpy6671fo31i7aypj9e0au1sbab.png", name: "抽象小丑", rarity: "common", type: "joker", effects: { mult: 3 }, tags: ["mult", "joker_count", "scaling"], description: "每有1张小丑，这张小丑就获得+3倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_riff_raff", "j_cartomancer"] },
        
        // 抽卡相关
        { id: "j_cartomancer", image: "https://patchwiki.biligame.com/images/balatro/d/de/ezv2labts99no53ak978lj33dqu6163.png", name: "卡牌术士", rarity: "uncommon", type: "joker", effects: { special: "create_tarot" }, tags: ["special", "tarot"], description: "选择盲注时，获得1张随机塔罗牌（必须有空位）", best_with: ["all"], synergies: ["j_abstract", "j_fortune_teller", "j_campfire"], synergy_note: "抽象小丑获额外倍率 | 占卜师每使用塔罗牌+1倍率 | 篝火每出售+×0.25，卡牌术士每盲注生成塔罗牌可出售喂篝火" },
        { id: "j_fortune_teller", image: "https://patchwiki.biligame.com/images/balatro/5/5e/pcgeplmwdtf4ee29ssmkqjuqglg0pzj.png", name: "占卜师", rarity: "common", type: "joker", effects: { mult: "tarot" }, tags: ["mult", "tarot", "scaling"], description: "本赛局内每使用过1张塔罗牌，这张小丑获得+1倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_cartomancer", "j_constellation"] },
        { id: "j_constellation", image: "https://patchwiki.biligame.com/images/balatro/8/80/m93qng5jrf8v9ky6pj3fhs011g2xugk.png", name: "星座", rarity: "uncommon", type: "joker", effects: { xmult: "planet" }, tags: ["xmult", "planet", "scaling"], description: "每使用1张星球牌，这张小丑获得×0.1倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_fortune_teller", "j_astronomer", "j_satellite"] },
        ...
        { id: "j_shortcut", image: "https://patchwiki.biligame.com/images/balatro/7/79/br3i4o0gqtf4w0x9peg9sk0b2drn3na.png", name: "捷径", rarity: "uncommon", type: "joker", effects: { special: "straight_gap" }, tags: ["special", "straight"], description: "让顺子可以相隔一个点数组成", best_with: ["straight"], synergies: ["j_crazy", "j_superposition", "j_runner"] },
        { id: "j_runner", image: "https://patchwiki.biligame.com/images/balatro/b/b9/cnxi23vtvbuxtwxp12sglo99g1ay3cq.png", name: "跑步选手", rarity: "common", type: "joker", effects: { chips: 15, hand: "straight" }, tags: ["chips", "hand", "scaling"], description: "如果打出的牌包含顺子，这张小丑获得+15筹码（起始+0筹码）", best_with: ["straight"], synergies: ["j_crazy", "j_order", "j_superposition", "j_shortcut"] },
        { id: "j_ice_cream", image: "https://patchwiki.biligame.com/images/balatro/4/49/p8tte4xqv0v3e3xjvk21w1le1i4792k.png", name: "冰淇淋", rarity: "common", type: "joker", effects: { chips: 100, chips_decay: 5 }, tags: ["chips", "decay", "scaling"], description: "+100筹码，每次出牌后这张小丑-5筹码", best_with: ["all"], synergies: [], synergy_note: "高初始筹码但逐渐衰减，适合早期爆发" },
        
        // 基础卡牌（无特殊协同）
        { id: "j_mime", image: "https://patchwiki.biligame.com/images/balatro/f/fc/7avkst1tqfea1ny4zeyzgch6lrui1so.png", name: "哑剧演员", rarity: "uncommon", type: "joker", effects: { special: "mime" }, tags: ["special", "scoring", "hand_trigger"], description: "额外触发1次所有留在手牌中的牌的能力", best_with: ["all"], synergies: ["j_steel", "j_seltzer", "j_dusk", "j_baron", "j_shoot_moon", "t_chariot"], synergy_note: "哑剧演员让手牌中的能力多触发1次：钢铁牌的×1.5再触发1次（变×2.25）、男爵K的×1.5再触发1次、射月Q的+13倍率再触发1次" },
        ...
        { id: "j_marble", image: "https://patchwiki.biligame.com/images/balatro/5/55/dtamo4pgkn7yr5vp40a44tf2u56wxsf.png", name: "大理石小丑", rarity: "uncommon", type: "joker", effects: { special: "stone" }, tags: ["special", "deck"], description: "选择盲注时，增加1张石头牌到牌组中", best_with: ["all"], synergies: ["j_stone", "j_hologram"] },
        { id: "j_loyalty", image: "https://patchwiki.biligame.com/images/balatro/1/14/qvt6hi39uy299q14boca3ezz2q39lzt.png", name: "积分卡", rarity: "uncommon", type: "joker", effects: { xmult: 4, trigger: 6 }, tags: ["xmult", "timing"], description: "每第6次出牌，给予×4倍率", best_with: ["all"], synergies: ["j_seltzer"] },
        ...
        { id: "j_dusk", image: "https://patchwiki.biligame.com/images/balatro/0/07/djsud7bh63esokfihghs6duk4t7l3ym.png", name: "黄昏", rarity: "uncommon", type: "joker", effects: { special: "dusk" }, tags: ["special", "scoring", "rescore"], description: "每回合最后1次出牌中打出并计分的牌会额外触发1次", best_with: ["all"], synergies: ["j_hanging_chad", "j_abstract"], synergy_note: "配合未断选票最大化重复打出，配合抽象小丑增加倍率" },
        ...
        { id: "j_ride_bus", image: "https://patchwiki.biligame.com/images/balatro/8/84/j4dlq5hj5nefkc79jnjwnmk3jwtimf8.png", name: "搭乘巴士", rarity: "common", type: "joker", effects: { mult: "consecutive" }, tags: ["mult", "consecutive", "scaling"], description: "连续打出没有计分的人头牌时，这张小丑获得+1倍率，失败将会重置为起始倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_even_steven", "j_odd_todd", "j_fibonacci", "j_walkie", "j_hack", "j_wee", "s_cryptid", "s_incantation"], synergy_note: "搭乘巴士要求只打数字牌不打人头牌：偶数史蒂文(偶数+4倍率)/奇数托德(奇数+31筹码)/斐波那契(2358+8倍率)/对讲机(104加成)/烂脱口秀演员(2345额外触发)/小小丑(2永久+8筹码)都为数字牌提供加成 | 神秘生物复制数字牌增加密度 | 咒语摧毁1牌生成4张强化数字牌" },
        { id: "j_space", image: "https://patchwiki.biligame.com/images/balatro/a/a7/kjn7jhxg51of35dwgr9eoig7hj9hvsl.png", name: "太空小丑", rarity: "uncommon", type: "joker", effects: { special: "upgrade", chance: 0.25 }, tags: ["special", "upgrade"], description: "有1/4的概率提升打出牌型的等级", best_with: ["all"], synergies: ["j_supernova", "j_oops_6"] },
        { id: "j_egg", image: "https://patchwiki.biligame.com/images/balatro/f/f5/tl060oghnlfl49nb0f56mglzo0iovzc.png", name: "鸡蛋", rarity: "common", type: "joker", effects: { economy: 3 }, tags: ["economy", "scaling"], description: "回合结束时，这张小丑的售价+$3", best_with: ["all"], synergies: ["j_golden", "j_to_moon", "j_bull", "j_bootstraps", "j_swashbuckler", "j_ceremonial"], synergy_note: "鸡蛋每回合售价+$3，侠盗将所有小丑总售价转化为倍率，鸡蛋单卡就能持续涨倍率 | 仪式匕首摧毁鸡蛋时获得超高售价2倍的永久倍率" },
        { id: "j_dna", image: "https://patchwiki.biligame.com/images/balatro/f/f3/rees1v02ta0b7zyfmyu1g7xoy1sbyy8.png", name: "DNA", rarity: "rare", type: "joker", effects: { special: "copy" }, tags: ["special", "copy"], description: "如果回合内的第1次出牌只有1张牌，则将其1张复制加入完整牌组中，并将该复制加入手牌", best_with: ["high_card"], synergies: ["j_half", "j_hologram", "j_hanging_chad", "j_hiker", "j_supernova", "j_blue"], synergy_note: "半张小丑出≤3张牌+20倍率 | 全息影像每复制+×0.25倍率 | 未断选票让单牌额外触发2次 | 徒步者反复出同一张单牌永久叠筹码 | 超新星每打高牌+倍率 | 蓝色小丑按牌组牌数+2筹码，DNA每回合复制加牌持续增强", unlock: "在回合第一手只打出1张牌" },
        ...
        { id: "j_blue", image: "https://patchwiki.biligame.com/images/balatro/6/62/evw6ijpwkbdxsxy5n1tf792cxrzpkam.png", name: "蓝色小丑", rarity: "common", type: "joker", effects: { chips: "deck_remaining" }, tags: ["chips", "deck", "scaling"], description: "当前牌组每有1张牌，这张小丑就获得+2筹码", best_with: ["all"], synergies: ["j_dna", "j_certificate", "j_marble"], synergy_note: "蓝色小丑按牌组剩余牌数给筹码，加牌流小丑直接增强：DNA复制单牌加入牌组、证书选盲注加蜡封牌、大理石小丑选盲注加石头牌，都能持续增加牌组总数提升筹码" },
        { id: "j_sixth_sense", image: "https://patchwiki.biligame.com/images/balatro/6/65/dfl8l0fv3wxk8yxwyi3abtj9wtmbv97.png", name: "第六感", rarity: "uncommon", type: "joker", effects: { special: "soul" }, tags: ["special", "soul"], description: "如果回合内的第一次出牌只有1张单独的6，则将其摧毁并获得1张随机的幻灵牌（必须有空间）", best_with: ["all"], synergies: ["j_seance", "j_fortune_teller", "j_erosion"] },
        { id: "j_hiker", image: "https://patchwiki.biligame.com/images/balatro/6/69/me7cjq9mrw2qqc04bz9993m7wjgbt19.png", name: "徒步者", rarity: "uncommon", type: "joker", effects: { chips: "permanent_5" }, tags: ["chips", "permanent", "scaling"], description: "打出的牌在计分时永久获得+5筹码", best_with: ["all"], synergies: ["j_splash", "j_hanging_chad", "j_dna"], synergy_note: "飞溅让所有打出的牌计分+5筹码 | 未断选票让第1张计分牌额外触发2次，永久+15筹码 | DNA反复出同一张单牌，筹码滚雪球叠加" },
        ...
        { id: "j_green", image: "https://patchwiki.biligame.com/images/balatro/7/7e/991g9xls64e2erk00a1uiudaih91zrt.png", name: "绿色小丑", rarity: "common", type: "joker", effects: { mult: "play", mult_neg: "discard" }, tags: ["mult", "play", "discard", "scaling"], description: "每次出牌这个小丑+1倍率，每次弃牌这个小丑-1倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_burglar"], synergy_note: "窃贼移除弃牌次数，使绿色小丑不会因弃牌扣倍率" },
        ...
        { id: "j_card_sharp", image: "https://patchwiki.biligame.com/images/balatro/1/15/rralu3t2r32s4qgue8xyti21e1j2li2.png", name: "老千小丑", rarity: "uncommon", type: "joker", effects: { xmult: 3, hand: "repeat" }, tags: ["xmult", "hand"], description: "如果打出的牌型在本回合中已经打出过，则给予×3倍率", best_with: ["all"], synergies: ["j_hanging_chad", "j_dusk"] },
        { id: "j_red", image: "https://patchwiki.biligame.com/images/balatro/0/02/4cl551wxfv2byvt5y1vctg43ecel2cb.png", name: "红牌", rarity: "common", type: "joker", effects: { mult: "skip", count: 3 }, tags: ["mult", "skip", "scaling"], description: "每次在补充包中按下跳过键，这张小丑牌获得+3倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_throwback"] },
        { id: "j_madness", image: "https://patchwiki.biligame.com/images/balatro/8/8b/1bch8eqfckweutkhvokdkqnw8qs8kbl.png", name: "疯狂", rarity: "uncommon", type: "joker", effects: { xmult: 0.5, destroy: "random" }, tags: ["xmult", "destroy", "scaling"], description: "选择小盲注或大盲注时，这张小丑牌获得×0.5倍率，并随机摧毁1张其他小丑牌（起始×1倍率）", best_with: ["all"], synergies: ["j_abstract"], synergy_note: "每回合摧毁Joker，抽象小丑获得额外倍率" },
        { id: "j_square", image: "https://patchwiki.biligame.com/images/balatro/e/e0/tnh9pullb74b6445e07ctr3x5hpstuc.png", name: "方形小丑", rarity: "common", type: "joker", effects: { chips: 4, hand_size: 4 }, tags: ["chips", "hand_size", "scaling"], description: "如果打出的牌的数量为4张，这张小丑获得+4筹码（起始+0筹码）", best_with: ["all"], synergies: ["j_turtle_bean", "j_juggler", "j_four_fingers", "j_spare_trousers"] },
        { id: "j_seance", image: "https://patchwiki.biligame.com/images/balatro/f/fd/ebyeuds3k3xyn38dtr3ykcfvzgwdfqu.png", name: "通灵", rarity: "uncommon", type: "joker", effects: { special: "spectral" }, tags: ["special", "spectral", "flush"], description: "如果打出的牌型为同花顺，则会获得1张随机的幻灵牌（必须有空位）", best_with: ["straight_flush"], synergies: ["j_fortune_teller", "j_constellation"] },
        ...
        { id: "j_vampire", image: "https://patchwiki.biligame.com/images/balatro/2/2f/eqtijo8jnuzlx7vwlx8olix8rf7y5ys.png", name: "吸血鬼", rarity: "uncommon", type: "joker", effects: { xmult: "augment", chance: 0.1 }, tags: ["xmult", "augment", "scaling"], description: "每打出1张计分的增强游戏牌，这张小丑获得×0.1倍率，并移除游戏牌的增强效果（起始×1倍率）", best_with: ["all"], synergies: ["t_empress", "t_emperor", "j_midas"], synergy_note: "迈达斯面具持续产出金卡供吸血鬼吸收，皇后/皇帝持续创造增强牌供吸血鬼消耗叠倍率" },
        { id: "j_hologram", image: "https://patchwiki.biligame.com/images/balatro/6/65/84em1b6mq32h83v4s4egu9xt5u91oa2.png", name: "全息影像", rarity: "uncommon", type: "joker", effects: { xmult: "card_added", value: 0.25 }, tags: ["xmult", "deck", "scaling"], description: "每添加1张游戏牌到你的完整牌组中，这个小丑获得×0.25倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_fortune_teller", "j_constellation", "j_dna", "j_certificate", "j_marble"], synergy_note: "占卜师/星座配合塔罗牌/行星牌使用间接加牌；DNA复制单牌加入牌组；证书选盲注时加牌；大理石小丑选盲注时加石头牌，均触发全息+×0.25" },
        { id: "j_vagabond", image: "https://patchwiki.biligame.com/images/balatro/2/20/0m0zilxvq8o22h2sue2akk9snho3zfn.png", name: "流浪者", rarity: "rare", type: "joker", effects: { special: "tarot", cost: 4 }, tags: ["special", "tarot"], description: "如果出牌时资金小于或等于$4，则生成1张随机塔罗牌（必须有空位）", best_with: ["all"], synergies: ["j_fortune_teller", "j_constellation", "j_cartomancer", "j_credit_card"], unlock: "手持$4或更少时打出牌" },
        { id: "j_cloud9", image: "https://patchwiki.biligame.com/images/balatro/4/4a/qa0hbe1o9zdtgq1xrada5j0f90xjr0i.png", name: "9霄云外", rarity: "uncommon", type: "joker", effects: { economy: "nine" }, tags: ["economy", "rank"], description: "完整牌组中每有1张9，回合结束时就获得$1", best_with: ["all"], synergies: ["j_to_moon", "j_bull", "j_bootstraps"] },
        { id: "j_obelisk", image: "https://patchwiki.biligame.com/images/balatro/d/d9/8m6xfs7ajv8gq3s84njh85wd9kdyyqm.png", name: "方尖石塔", rarity: "rare", type: "joker", effects: { xmult: "uncommon_hand", value: 0.2 }, tags: ["xmult", "hand", "scaling"], description: "连续打出你不是最常用的牌型时，这个小丑获得×0.2倍率，失败将会重置为起始倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_straight", "j_tribe", "j_two_pair", "j_burglar"], synergy_note: "窃贼失去弃牌只能出牌，被迫多打非常用牌型，方尖石塔快速叠加X倍率" },
        { id: "j_midas", image: "https://patchwiki.biligame.com/images/balatro/e/e7/7mxa1mkl2bwsxmqrpdxmybih802r6zt.png", name: "迈达斯面具", rarity: "uncommon", type: "joker", effects: { special: "gold" }, tags: ["special", "gold", "face"], description: "打出的人头牌在计分时变为黄金牌", best_with: ["all"], synergies: ["j_golden_ticket", "j_pareidolia", "j_vampire", "j_sock"], synergy_note: "迈达斯面具持续将人头牌变成金卡，为吸血鬼提供源源不断的增强牌来吸收；喜与悲人头牌额外触发增加变金效率" },
        { id: "j_luchador", image: "https://patchwiki.biligame.com/images/balatro/6/6d/f3wrhpore92ya3p5iv5uevqv885yi5c.png", name: "摔跤手", rarity: "uncommon", type: "joker", effects: { special: "disable_boss" }, tags: ["special", "boss"], description: "售出这张小丑牌会消除当前boss盲注的效果", best_with: ["all"], synergies: ["j_chicot"] },
        { id: "j_gift_card", image: "https://patchwiki.biligame.com/images/balatro/c/c9/dkef25sjbs1qx2vrh22kp4u8rgvvwod.png", name: "礼品卡", rarity: "uncommon", type: "joker", effects: { economy: "selling" }, tags: ["economy", "scaling"], description: "回合结束时，使持有的小丑牌和消耗牌售价+$1", best_with: ["all"], synergies: ["j_campfire", "j_swashbuckler", "j_ceremonial", "j_bull", "j_bootstraps"], synergy_note: "侠盗将所有小丑总售价转化为倍率，礼品卡每回合+$1售价直接帮侠盗涨倍率 | 仪式匕首摧毁右侧小丑获售价2倍永久倍率，礼品卡抬高售价让匕首吃更多 | 篝火出售+×0.25叠加" },
        { id: "j_turtle_bean", image: "https://patchwiki.biligame.com/images/balatro/4/4d/qmehu20rmsr4j81bjt76ey36050zi76.png", name: "黑龟豆", rarity: "uncommon", type: "joker", effects: { hand_size: 5 }, tags: ["hand_size"], description: "+5手牌上限，回合结束时-1手牌上限", best_with: ["all"], synergies: ["j_juggler", "j_square"] },
        { id: "j_erosion", image: "https://patchwiki.biligame.com/images/balatro/b/b9/qm9atscbtq9q078awsd1iocsfdzq8x8.png", name: "侵蚀", rarity: "uncommon", type: "joker", effects: { mult: "lower_cards" }, tags: ["mult", "deck", "scaling"], description: "当前的完整牌组数量每比初始的完整牌组数量少1张，这个小丑就获得+4倍率（起始+0倍率）", best_with: ["all"], synergies: ["t_hanged", "s_immolate", "j_sixth_sense", "j_canio"], synergy_note: "倒吊人移除2张牌=+8倍率；火祭摧毁5张牌=+20倍率且获$20；第六感摧毁6减少牌组+4倍率；卡尼奥摧毁人头牌叠X倍率，与侵蚀+倍率双重收益" },
        ...
        { id: "j_stone", image: "https://patchwiki.biligame.com/images/balatro/f/f9/12kdaiabrki0nea23x3bv0sg1zajeog.png", name: "石头小丑", rarity: "uncommon", type: "joker", effects: { chips: "stone" }, tags: ["chips", "stone", "scaling"], description: "完整牌组内每有1张石头牌，这个小丑牌获得+25筹码（起始+0筹码）", best_with: ["all"], synergies: ["j_marble"] },
        { id: "j_lucky_cat", image: "https://patchwiki.biligame.com/images/balatro/0/00/n12p2x6idikwbdq69hlbwz6yare5nob.png", name: "招财猫", rarity: "uncommon", type: "joker", effects: { xmult: "lucky", value: 0.25 }, tags: ["xmult", "lucky", "scaling"], description: "每次幸运牌被触发时，这张小丑获得×0.25倍率（起始×1倍率）", best_with: ["all"], synergies: ["t_magician", "j_oops_6"] },
        { id: "j_baseball", image: "https://patchwiki.biligame.com/images/balatro/b/b0/i7fuph3847pmy3clsgeyhknj5w2bzb6.png", name: "棒球卡", rarity: "rare", type: "joker", effects: { xmult: "rare_joker", value: 1.5 }, tags: ["xmult", "rare"], description: "每张罕见小丑会给予×1.5倍率", best_with: ["all"], synergies: ["j_steel", "j_hack", "j_glass", "j_mime", "j_card_sharp", "j_seance", "j_constellation"], synergy_note: "棒球卡让每张稀有小丑额外×1.5倍率，稀有小丑越多倍率越恐怖。钢铁小丑(稀有)、烂脱口秀演员(稀有)、玻璃小丑(稀有)、哑剧演员(稀有)、老千小丑(稀有)、通灵(稀有)、星座(稀有)都是强力稀有小丑" },
        { id: "j_bull", image: "https://patchwiki.biligame.com/images/balatro/f/f1/0bv6vuas274xzrf59v7lnahlt5mmp7t.png", name: "斗牛", rarity: "uncommon", type: "joker", effects: { chips: "money", value: 2 }, tags: ["chips", "economy", "scaling"], description: "每持有$1这个小丑就获得+2筹码", best_with: ["all"], synergies: ["j_golden", "j_to_moon", "j_bootstraps", "j_rocket", "j_credit_card", "j_delayed", "j_business_card", "j_egg", "j_faceless", "j_todo", "j_cloud9", "j_gift_card", "j_reserved", "j_mail_in", "j_trading", "j_golden_ticket", "j_matador", "j_satellite", "j_rough_gem"] },
        { id: "j_diet_cola", image: "https://patchwiki.biligame.com/images/balatro/c/c6/2ypdeu1bjm7x5152k6bysdm8yi4f3vd.png", name: "零糖可乐", rarity: "uncommon", type: "joker", effects: { special: "double" }, tags: ["special", "double"], description: "售出这张小丑牌会获得1个双倍标签", best_with: ["all"], synergies: ["j_campfire"] },
        { id: "j_trading", image: "https://patchwiki.biligame.com/images/balatro/a/a6/okf4gyhj4vrhe7ow0xkyb2avza98tyh.png", name: "交易卡", rarity: "uncommon", type: "joker", effects: { economy: "single_discard", value: 3 }, tags: ["economy", "discard"], description: "如果回合内的第一次弃牌只有1张牌，则会将其摧毁并获得$3", best_with: ["all"], synergies: ["j_drunkard", "j_merry_andy", "j_bull", "j_bootstraps"] },
        { id: "j_flash", image: "https://patchwiki.biligame.com/images/balatro/0/0d/nmdc2mxq87sx1p585nj0dqd87n4baog.png", name: "闪示卡", rarity: "uncommon", type: "joker", effects: { mult: "reroll" }, tags: ["mult", "shop", "scaling"], description: "每在商店中重掷1次，这个小丑获得+2倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_chaos"] },
        { id: "j_popcorn", image: "https://patchwiki.biligame.com/images/balatro/4/46/6b4o5i84zjaozaffhv1hcbctu53tcid.png", name: "爆米花", rarity: "common", type: "joker", effects: { mult: 20, mult_decay: 4 }, tags: ["mult", "decay", "scaling"], description: "+20倍率，回合结束时这个小丑-4倍率", best_with: ["all"], synergies: [] },
        { id: "j_spare_trousers", image: "https://patchwiki.biligame.com/images/balatro/a/a2/0oeftdb257l6nk8getn12jrch630smg.png", name: "备用裤子", rarity: "uncommon", type: "joker", effects: { mult: "two_pair" }, tags: ["mult", "hand", "scaling"], hand: "two_pair", description: "如果打出的牌包含两对，这个小丑获得+2倍率（起始+0倍率）", best_with: ["two_pair"], synergies: ["j_mad", "j_clever", "j_jolly", "j_four_fingers", "j_square", "j_duo"], synergy_note: "疯狂小丑+10倍率、聪敏小丑+80筹码，两对核心三件套；开心小丑对子也在两对内触发；四指降低组牌门槛；二重奏×2倍率在打两对时也会触发" },
        { id: "j_ancient", image: "https://patchwiki.biligame.com/images/balatro/8/8c/gio0i781jyrndhf35zrokkhmv3nk3mx.png", name: "古老小丑", rarity: "rare", type: "joker", effects: { xmult: 1.5, suit: "changing" }, tags: ["xmult", "suit", "changing"], description: "打出的（对应花色）牌在计分时会给予×1.5倍率，每个回合结束时需求花色都会改变", best_with: ["all"], synergies: ["j_smeared"] },
        { id: "j_ramen", image: "https://patchwiki.biligame.com/images/balatro/f/f6/jdfe5s4i7vlw5hi425fb80phj0x2e2f.png", name: "拉面", rarity: "uncommon", type: "joker", effects: { xmult: 2, mult_neg: "discard" }, tags: ["xmult", "discard", "scaling"], description: "×2倍率，每弃1张牌失去×0.01倍率", best_with: ["all"], synergies: ["j_burglar"], synergy_note: "窃贼移除所有弃牌次数，使拉面保持满倍率" },
        { id: "j_seltzer", image: "https://patchwiki.biligame.com/images/balatro/d/d7/9aq7q8lpby4yi7skwoyzkdnse60i7k1.png", name: "苏打水", rarity: "uncommon", type: "joker", effects: { special: "reset", count: 10 }, tags: ["special", "reset"], description: "接下来的10次出牌中打出并计分的牌会额外触发1次", best_with: ["all"], synergies: ["j_hack", "j_hanging_chad"] },
        { id: "j_castle", image: "https://patchwiki.biligame.com/images/balatro/9/98/hhdq8tip39ckmuq856ixkiagsk3rpn4.png", name: "城堡", rarity: "uncommon", type: "joker", effects: { chips: "suit_discard", suit: "changing" }, tags: ["chips", "discard", "suit", "scaling"], description: "每弃掉1张（对应花色）牌，这个小丑牌获得+3筹码，每个回合结束时花色都会改变（起始+0筹码）", best_with: ["all"], synergies: ["j_drunkard", "j_merry_andy"] },
        { id: "j_campfire", image: "https://patchwiki.biligame.com/images/balatro/1/1a/mll86mdw41y8mu40ac4xe2cwgpzsb9w.png", name: "篝火", rarity: "rare", type: "joker", effects: { xmult: "sell", value: 0.25 }, tags: ["xmult", "sell", "boss", "scaling"], description: "每售出1张牌，这个小丑获得×0.25倍率，击败boss盲注后重置为起始倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_gift_card", "j_diet_cola", "j_riff_raff", "j_cartomancer"], synergy_note: "礼品卡抬高售价增值 | 零糖可乐出售创造免费双倍 | 乌合之众每盲注生成2张小丑可出售喂篝火+×0.5 | 卡牌术士每盲注生成塔罗牌可出售喂篝火+×0.25" },
        ...
        { id: "j_mr_bones", image: "https://patchwiki.biligame.com/images/balatro/9/91/0mcxv3tmuec5u177lfd7awozjxu5ozt.png", name: "骷髅先生", rarity: "uncommon", type: "joker", effects: { special: "survive" }, tags: ["special", "survive"], description: "如果最终得到的分数至少是所需分数的25%，则不会死亡，随后自毁", best_with: ["all"], synergies: [], unlock: "输掉5局游戏" },
        { id: "j_acrobat", image: "https://patchwiki.biligame.com/images/balatro/3/35/b2m363vpkvsiyi6t067koete7i3no7m.png", name: "杂技演员", rarity: "uncommon", type: "joker", effects: { xmult: 3, position: "last" }, tags: ["xmult", "position"], description: "每回合的最后1次出牌，给予×3倍率", best_with: ["all"], synergies: ["j_dusk"], unlock: "打出200手牌" },
        { id: "j_swashbuckler", image: "https://patchwiki.biligame.com/images/balatro/2/2e/pq3ixa0eabrbzgvqy54xzj7870y6taw.png", name: "侠盗", rarity: "common", type: "joker", effects: { mult: "sell_value" }, tags: ["mult", "sell", "scaling"], description: "将当前拥有的其他小丑的总售价增加至这个小丑的倍率", best_with: ["all"], synergies: ["j_campfire", "j_gift_card", "j_egg", "j_ceremonial"], synergy_note: "礼品卡每回合给所有小丑售价+$1，侠盗直接将总售价转化为倍率 | 鸡蛋每回合售价+$3，单卡即可为侠盗持续涨倍率 | 仪式匕首摧毁高售价小丑后售价重置，侠盗与匕首的倍率来源互补 | 篝火出售+×0.25配合出售体系", unlock: "出售20张小丑牌" },
        { id: "j_troubadour", image: "https://patchwiki.biligame.com/images/balatro/e/ef/jw8tim438bd086s8t5b3apijamdl339.png", name: "游吟诗人", rarity: "uncommon", type: "joker", effects: { hand_size: 2, hand_size_neg: 1 }, tags: ["hand_size"], description: "+2手牌上限，-1出牌次数", best_with: ["all"], synergies: ["j_juggler", "j_turtle_bean"], unlock: "连续5个回合每回合只出1手牌（可弃牌）" },
        { id: "j_certificate", image: "https://patchwiki.biligame.com/images/balatro/b/b1/frhkys40shtjxvvf9niot44u0yodml3.png", name: "证书", rarity: "uncommon", type: "joker", effects: { special: "seal" }, tags: ["special", "seal"], description: "选择盲注时，增加1张带有随机蜡封的游戏牌到手牌中，并将其加入完整牌堆中", best_with: ["all"], synergies: ["j_hologram", "j_steel"], synergy_note: "全息影像每加牌+×0.25倍率 | 证书加牌后用战车变钢铁牌，钢铁小丑每张钢铁牌+×0.2倍率", unlock: "拥有1张带金封印的黄金牌" },
        { id: "j_smeared", image: "https://patchwiki.biligame.com/images/balatro/e/e0/g31kfrkay37zlrscabfaste16mb066q.png", name: "模糊小丑", rarity: "uncommon", type: "joker", effects: { special: "suit_combine" }, tags: ["special", "suit"], description: "和视为同一花色，和视为同一花色", best_with: ["all"], synergies: ["j_greedy", "j_lusty", "j_wrathful", "j_gluttonous", "j_blackboard", "j_flower_pot", "j_ancient", "j_bloodstone", "j_arrowhead", "j_onyx", "j_rough_gem", "j_seeing_double"], synergy_note: "模糊小丑让红桃=方块、黑桃=梅花，所有指定花色的小丑触发范围翻倍", unlock: "牌组中拥有3张或以上万能牌" },
        { id: "j_throwback", image: "https://patchwiki.biligame.com/images/balatro/4/4e/1r4xoa54zwfs2ejf2nlyz61qst8xsvk.png", name: "回溯", rarity: "uncommon", type: "joker", effects: { xmult: "skip", value: 0.25 }, tags: ["xmult", "skip", "scaling"], description: "本赛局每跳过1次盲注，这个小丑获得×0.25倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_red"], unlock: "从主菜单继续一局游戏" },
        ...
        { id: "j_glass", image: "https://patchwiki.biligame.com/images/balatro/3/3b/rfytilg6srxq9z4yq6al7ute9ui58op.png", name: "玻璃小丑", rarity: "uncommon", type: "joker", effects: { xmult: "glass", value: 0.75 }, tags: ["xmult", "glass", "destroy", "scaling"], description: "每摧毁1张玻璃牌，这个小丑获得×0.75倍率（起始×1倍率）", best_with: ["all"], synergies: ["t_justice", "t_fool"], synergy_note: "正义创造玻璃牌，愚者复制正义，持续供应玻璃牌被摧毁来叠加倍率" },
        { id: "j_showman", image: "https://patchwiki.biligame.com/images/balatro/9/9b/mh0ujc03do7tbef4l8ckwr2l4w5ruth.png", name: "马戏团长", rarity: "uncommon", type: "joker", effects: { special: "duplicates" }, tags: ["special"], description: "小丑牌、塔罗牌、星球牌、幻灵牌可以同时出现复数张", best_with: ["all"], synergies: ["j_blueprint", "j_brainstorm"] },
        { id: "j_wee", image: "https://patchwiki.biligame.com/images/balatro/6/62/ckzkxdjcrb2bzd4qt6g5xxadca57lvm.png", name: "小小丑", rarity: "rare", type: "joker", effects: { chips: 8, rank: [2] }, tags: ["chips", "rank", "rescore", "scaling"], description: "打出的2在计分时使这个小丑获得+8筹码（起始+0筹码）", best_with: ["all"], synergies: ["j_hanging_chad", "j_fibonacci", "j_even_steven", "j_hack", "j_ride_bus"], synergy_note: "未断选票重复触发；斐波那契2+8倍率叠加；偶数史蒂文2+4倍率叠加；烂脱口秀演员重置2反复计分 | 搭乘巴士鼓励只打数字牌，2是最小的数字牌" },
        { id: "j_oops_6", image: "https://patchwiki.biligame.com/images/balatro/f/f5/cxelu1uofv9vozxjcpxnqo6lie7h244.png", name: "六六大顺", rarity: "uncommon", type: "joker", effects: { special: "double_chance" }, tags: ["special", "chance"], description: "将所有以数字列出的概率翻倍", best_with: ["all"], synergies: ["j_bloodstone", "j_space", "j_lucky_cat", "j_gros_michel", "j_8ball", "j_business_card"], synergy_note: "概率翻倍：血石1/2→1/1必触发X1.5、太空1/4→1/2升级牌型、招财猫翻倍触发、大麦克1/6→1/3自毁风险加大、8号球1/4→1/2生成塔罗、名片1/2→1/1人头牌必给$2" },
        { id: "j_idol", image: "https://patchwiki.biligame.com/images/balatro/9/94/34ugrmo8yflm04qhztxe80p4mo7euqf.png", name: "偶像", rarity: "uncommon", type: "joker", effects: { xmult: 2, rank: "changing", suit: "changing" }, tags: ["xmult", "changing"], description: "每张打出的（对应花色）（对应点数）在计分时给予×2倍率，每个回合结束时花色和点数都会改变", best_with: ["all"], synergies: [] },
        { id: "j_seeing_double", image: "https://patchwiki.biligame.com/images/balatro/3/36/sthpwsj0nzi52zerh5n4zihctue8s3b.png", name: "重影", rarity: "uncommon", type: "joker", effects: { xmult: 2, hand: "suit_mix" }, tags: ["xmult", "suit"], description: "如果打出的牌中包含1张计分的花色牌和1张计分的其他花色牌，则给予×2倍率", best_with: ["all"], synergies: ["j_gluttonous", "j_smeared"], unlock: "打出包含四张梅花7的一手牌" },
        { id: "j_matador", image: "https://patchwiki.biligame.com/images/balatro/d/d9/f39fqr9bz8vyx4vhq8dw8l4yon7yjvq.png", name: "斗牛士", rarity: "uncommon", type: "joker", effects: { economy: "boss_trigger", value: 8 }, tags: ["economy", "boss"], description: "如果打出的牌有削弱的牌或触发了boss盲注的限制条件，获得$8", best_with: ["all"], synergies: ["j_luchador", "j_chicot", "j_bull", "j_bootstraps"] },
        { id: "j_stuntman", image: "https://patchwiki.biligame.com/images/balatro/9/97/sacgmbf2gs5lmnopa0kn0vv5fg6rzuj.png", name: "特技演员", rarity: "rare", type: "joker", effects: { chips: 250, hand_size: -2 }, tags: ["chips", "hand_size"], description: "+250筹码，-2手牌上限", best_with: ["all"], synergies: ["j_juggler", "j_turtle_bean", "j_half"], synergy_note: "手牌-2更容易达到半张小丑3张或更少的条件；杂耍师/龟豆可补回手牌数" },
        { id: "j_invisible", image: "https://patchwiki.biligame.com/images/balatro/2/26/pee9m8nbc9r9ely9iej8fw5h5gijkof.png", name: "隐形小丑", rarity: "rare", type: "joker", effects: { special: "delayed_copy" }, tags: ["special", "copy"], description: "经过2个回合后，售出这张小丑牌会随机复制1张拥有的小丑牌（移除复制获得的小丑的负片版本）", best_with: ["all"], synergies: ["j_blueprint"], unlock: "赢得1局游戏，且从未超过4张小丑" },
        { id: "j_satellite", image: "https://patchwiki.biligame.com/images/balatro/0/02/s0nxq1tk8sprjexsr15y8gi4q8ksgzm.png", name: "卫星", rarity: "uncommon", type: "joker", effects: { economy: "unique_planet" }, tags: ["economy", "planet", "scaling"], description: "本赛局每使用过1种星球牌，回合结束时就获得$1（起始$0）", best_with: ["all"], synergies: ["j_astronomer", "j_constellation", "j_bull", "j_bootstraps"], synergy_note: "天文学家让行星牌免费，卫星每种独特行星+$1，免费拿行星快速叠收入 | 星座每用行星+×0.1倍率 | 斗牛/提靴带把卫星赚的钱转筹码/倍率" },
        { id: "j_driver_license", image: "https://patchwiki.biligame.com/images/balatro/e/e4/t1vvh5m7j62wx1ho8nqkjj5s115yctm.png", name: "驾驶执照", rarity: "rare", type: "joker", effects: { xmult: 3, augment_count: 16 }, tags: ["xmult", "augment"], description: "如果你的完整牌组中有16张以上的增强卡牌，则给予×3倍率", best_with: ["all"], synergies: ["t_empress", "t_emperor"], synergy_note: "皇后/皇帝持续创造增强牌帮助达到16张门槛", unlock: "牌组中强化16张牌" },
        { id: "j_astronomer", image: "https://patchwiki.biligame.com/images/balatro/6/68/cytjlep1tyb007tdx7opxxooy9uc2rb.png", name: "天文学家", rarity: "uncommon", type: "joker", effects: { special: "free_planet" }, tags: ["special", "planet", "shop"], description: "商店中的所有星球牌和天体补充包免费", best_with: ["all"], synergies: ["j_constellation", "j_satellite"], synergy_note: "星座每用行星+×0.1倍率，天文学家免费拿行星无限叠 | 卫星每种独特行星+$1，天文学家免费获取加速卫星收入" },
        { id: "j_burnt", image: "https://patchwiki.biligame.com/images/balatro/f/f0/lijn2uaiykusk533zmiqv5sns5roukf.png", name: "烧焦小丑", rarity: "rare", type: "joker", effects: { special: "upgrade_discard" }, tags: ["special", "upgrade", "discard"], description: "每个回合升级你第一次弃牌弃掉的牌型", best_with: ["all"], synergies: ["j_drunkard", "j_merry_andy"] },
        { id: "j_bootstraps", image: "https://patchwiki.biligame.com/images/balatro/d/da/i0vqh5izpx0xuwefhjeonj60onczpjy.png", name: "提靴带", rarity: "uncommon", type: "joker", effects: { mult: "money", value: 2, interval: 5 }, tags: ["mult", "economy", "scaling"], description: "每持有$5这个小丑就获得+2倍率", best_with: ["all"], synergies: ["j_golden", "j_to_moon", "j_bull", "j_rocket", "j_delayed", "j_business_card", "j_egg", "j_faceless", "j_todo", "j_cloud9", "j_gift_card", "j_reserved", "j_mail_in", "j_trading", "j_golden_ticket", "j_matador", "j_satellite", "j_rough_gem"] },
        { id: "j_yorick", image: "https://patchwiki.biligame.com/images/balatro/f/f8/5p1lnj732ybix5gxetvztxjkmgexbpb.png", name: "约里克", rarity: "legendary", type: "joker", effects: { xmult: "discard_count", value: 1, count: 23 }, tags: ["xmult", "discard", "scaling"], description: "每弃掉23张牌后，这个小丑获得×1倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_burnt", "j_drunkard", "j_merry_andy"], synergy_note: "醉汉/快乐安迪增加弃牌次数，帮助快速达到23张弃牌；烧焦小丑同为弃牌流双核", unlock: "通过灵魂牌发现" },
