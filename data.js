...
const CARD_DATA = {
    ...
    jokers: [
        ...
        // 花色小丑
        { id: "j_greedy", image: "https://patchwiki.biligame.com/images/balatro/f/fa/eakt0eeo4w1uwytj0q7ipmwv53l9v9r.png", name: "贪婪小丑", rarity: "common", type: "joker", effects: { mult: 3 }, tags: ["mult", "suit"], suit: "diamonds", description: "打出的花色牌在计分时给予+3倍率", best_with: ["flush", "straight_flush"], synergies: ["j_lusty", "j_wrathful", "j_gluttonous", "j_flower_pot", "j_rough_gem", "j_hanging_chad"] },
        { id: "j_lusty", image: "https://patchwiki.biligame.com/images/balatro/8/80/b5x4nierifec18qs2apxorbdfehzwfj.png", name: "色欲小丑", rarity: "common", type: "joker", effects: { mult: 3 }, tags: ["mult", "suit"], suit: "hearts", description: "打出的花色牌在计分时给予+3倍率", best_with: ["flush", "straight_flush"], synergies: ["j_greedy", "j_wrathful", "j_gluttonous", "j_bloodstone", "j_flower_pot", "j_hanging_chad"] },
        { id: "j_wrathful", image: "https://patchwiki.biligame.com/images/balatro/3/3c/6lb6wgmvn3w8srp2ftlq92wj7wbl8lr.png", name: "愤怒小丑", rarity: "common", type: "joker", effects: { mult: 3 }, tags: ["mult", "suit"], suit: "spades", description: "打出的花色牌在计分时给予+3倍率", best_with: ["flush", "straight_flush"], synergies: ["j_greedy", "j_lusty", "j_gluttonous", "j_arrowhead", "j_flower_pot", "j_hanging_chad"] },
        { id: "j_gluttonous", image: "https://patchwiki.biligame.com/images/balatro/a/a5/8fo15fuqxf8l8zsuzkxmol401rt282d.png", name: "暴食小丑", rarity: "common", type: "joker", effects: { mult: 3 }, tags: ["mult", "suit"], suit: "clubs", description: "打出的花色牌在计分时给予+3倍率", best_with: ["flush", "straight_flush"], synergies: ["j_greedy", "j_lusty", "j_wrathful", "j_onyx", "j_flower_pot", "j_smeared", "j_hanging_chad"] },
        
        // 牌型小丑 - 倍数
        { id: "j_jolly", image: "https://patchwiki.biligame.com/images/balatro/1/1a/h1jmgbhs9qvpmno2l74jax4az7p9xq1.png", name: "开心小丑", rarity: "common", type: "joker", effects: { mult: 8 }, tags: ["mult", "hand"], hand: "pair", description: "如果打出的牌包含对子给予+8倍率", best_with: ["one_pair"], synergies: ["j_duo", "j_spare_trousers", "j_mad", "j_clever"], synergy_note: "两对包含对子，打两对时开心小丑+8倍率也会触发，与疯狂小丑/聪敏小丑/备用裤子组成双对流" },
        { id: "j_zany", image: "https://patchwiki.biligame.com/images/balatro/2/29/bpwwkcz4qjtrls91dx3952bwh8kgin7.png", name: "古怪小丑", rarity: "common", type: "joker", effects: { mult: 12 }, tags: ["mult", "hand"], hand: "three_of_a_kind", description: "如果打出的牌包含三条给予+12倍率", best_with: ["three_of_a_kind"], synergies: ["j_trio"] },
        { id: "j_mad", image: "https://patchwiki.biligame.com/images/balatro/8/8a/2w09lj3xk1yg7oa3sip2kv0z8j7jd84.png", name: "疯狂小丑", rarity: "common", type: "joker", effects: { mult: 10 }, tags: ["mult", "hand"], hand: "two_pair", description: "如果打出的牌包含两对给予+10倍率", best_with: ["two_pair"], synergies: ["j_spare_trousers", "j_clever", "j_jolly", "j_sly"], synergy_note: "备用裤子永久+倍率，聪敏小丑+80筹码，两对核心三件套；开心小丑/奸诈小丑对子效果也在两对中触发" },
        ...
        { id: "j_droll", image: "https://patchwiki.biligame.com/images/balatro/f/fe/irqubwjpnifl8qwy8hfn8im12jvbfuc.png", name: "滑稽小丑", rarity: "common", type: "joker", effects: { mult: 10 }, tags: ["mult", "hand"], hand: "flush", description: "如果打出的牌包含同花给予+10倍率", best_with: ["flush"], synergies: ["j_tribe", "j_smeared", "j_runner", "j_rough_gem", "j_arrowhead"] },
        ...
        { id: "j_wily", image: "https://patchwiki.biligame.com/images/balatro/8/8b/ck7l12j5xddt9fim7k0s48b3qseb4o1.png", name: "狡猾小丑", rarity: "common", type: "joker", effects: { chips: 100 }, tags: ["chips", "hand"], hand: "three_of_a_kind", description: "如果打出的牌包含三条给予+100筹码", best_with: ["three_of_a_kind"], synergies: ["j_zany", "j_trio"] },
        { id: "j_clever", image: "https://patchwiki.biligame.com/images/balatro/3/3c/th0b5s47l29mv7vixsnko4oydqy07pf.png", name: "聪敏小丑", rarity: "common", type: "joker", effects: { chips: 80 }, tags: ["chips", "hand"], hand: "two_pair", description: "如果打出的牌包含两对给予+80筹码", best_with: ["two_pair"], synergies: ["j_mad", "j_spare_trousers", "j_jolly", "j_sly"], synergy_note: "疯狂小丑+10倍率，备用裤子永久+倍率，两对核心三件套；开心小丑/奸诈小丑对子效果也在两对中触发" },
        ...
        { id: "j_canio", image: "https://patchwiki.biligame.com/images/balatro/7/71/nsvckiuc1hmattmkxal0z2qrs4bb768.png", name: "卡尼奥", rarity: "legendary", type: "joker", effects: { xmult: "destroy_face" }, tags: ["xmult", "destroy", "face"], description: "每当1张人头牌被摧毁时，这个小丑获得×1倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_hit_road", "j_pareidolia"] },
        
        // 10/4 相关
        { id: "j_walkie", image: "https://patchwiki.biligame.com/images/balatro/e/e0/e2w9o0w9zthkk19phfyqq2n8bmxzyqx.png", name: "对讲机", rarity: "common", type: "joker", effects: { chips: 10, mult: 4, rank: [10, 4] }, tags: ["chips", "mult", "rank"], description: "打出的10和4在计分时给予+10筹码与+4倍率", best_with: ["all"], synergies: ["j_even_steven", "j_hack", "j_hanging_chad"], synergy_note: "10和4都是偶数，触发偶数史蒂文；4在烂脱口秀演员重置范围(2,3,4,5)内，重置后反复触发 | 未断选票让第1张计分牌额外触发2次，+10筹码+4倍率变+30筹码+12倍率" },
        
        // 牌型倍率组合
        { id: "j_duo", image: "https://patchwiki.biligame.com/images/balatro/8/8a/3ks8my2xjjnqd35ycva8hb818wtfyed.png", name: "二重奏", rarity: "legendary", type: "joker", effects: { xmult: 2, hand: "pair" }, tags: ["xmult", "hand"], description: "如果打出的牌包含对子，则给予×2倍率", best_with: ["one_pair"], synergies: ["j_jolly"] },
        { id: "j_trio", image: "https://patchwiki.biligame.com/images/balatro/e/eb/4xqxpbecldizspgovlu5tdtr132ox70.png", name: "三重奏", rarity: "legendary", type: "joker", effects: { xmult: 3, hand: "three" }, tags: ["xmult", "hand"], description: "如果打出的牌包含三条，则给予×3倍率", best_with: ["three_of_a_kind"], synergies: ["j_zany"] },
        { id: "j_family", image: "https://patchwiki.biligame.com/images/balatro/4/41/k3uw3hqr7cj21ej6nk03qyek0gygahf.png", name: "一家人", rarity: "legendary", type: "joker", effects: { xmult: 4, hand: "four" }, tags: ["xmult", "hand"], description: "如果打出的牌包含四条，则给予×4倍率", best_with: ["four_of_a_kind"], synergies: ["j_trio"] },
        { id: "j_order", image: "https://patchwiki.biligame.com/images/balatro/c/cc/4oo4dn3pyv959nw5l1a2kjzzdjmu1pd.png", name: "秩序", rarity: "legendary", type: "joker", effects: { xmult: 3, hand: "straight" }, tags: ["xmult", "hand"], description: "如果打出的牌包含顺子，则给予×3倍率", best_with: ["straight"], synergies: ["j_crazy"] },
        { id: "j_tribe", image: "https://patchwiki.biligame.com/images/balatro/e/e0/i57gzzij7kd0dmsu7ofzl26zjpv2tp9.png", name: "部落", rarity: "legendary", type: "joker", effects: { xmult: 2, hand: "flush" }, tags: ["xmult", "hand"], description: "如果打出的牌包含同花，则给予×2倍率", best_with: ["flush"], synergies: ["j_droll", "j_smeared", "j_rough_gem"] },
        ...
        { id: "j_bloodstone", image: "https://patchwiki.biligame.com/images/balatro/0/0b/5by0c814rvrs5wf1rg3m9zs89pr8vuk.png", name: "血石", rarity: "rare", type: "joker", effects: { xmult: 1.5, suit: "hearts", chance: 0.5 }, tags: ["xmult", "suit", "chance"], description: "打出的花色牌在计分时有1/2的概率给予×1.5倍率", best_with: ["flush"], synergies: ["j_lusty", "j_gros_michel", "j_smeared", "j_hanging_chad"], synergy_note: "未断选票让第1张计分牌额外触发2次，多2次机会触发X1.5倍率" },
        { id: "j_arrowhead", image: "https://patchwiki.biligame.com/images/balatro/f/fe/qrnz9huicaxe3c4srbc6iu47h9n8mq1.png", name: "箭头", rarity: "rare", type: "joker", effects: { chips: 50, suit: "spades" }, tags: ["chips", "suit"], description: "打出的花色牌在计分时给予+50筹码", best_with: ["straight", "flush"], synergies: ["j_wrathful", "j_blackboard", "j_smeared", "j_droll", "j_crafty", "j_hanging_chad"], synergy_note: "箭头黑桃+50筹码，与愤怒小丑同花色协同，黑板全黑系，模糊小丑扩大触发范围，滑稽/精明同花体系配合 | 未断选票让第1张计分牌额外触发2次，+50筹码变+150筹码", unlock: "牌组中拥有至少30张黑桃" },
        { id: "j_onyx", image: "https://patchwiki.biligame.com/images/balatro/b/b6/j3stvd4iadcz74dpao20x7wqy4dwtd8.png", name: "缟玛瑙", rarity: "rare", type: "joker", effects: { mult: 7, suit: "clubs" }, tags: ["mult", "suit"], description: "打出的花色牌在计分时给予+7倍率", best_with: ["flush"], synergies: ["j_gluttonous", "j_blackboard", "j_smeared", "j_hanging_chad"] },
        { id: "j_rough_gem", image: "https://patchwiki.biligame.com/images/balatro/8/82/to4w28fzybcjdl1hnw4ilptjnqxz89l.png", name: "璞玉", rarity: "rare", type: "joker", effects: { economy: "diamonds", value: 1 }, tags: ["economy", "suit"], description: "打出的花色牌在计分时获得$1", best_with: ["flush", "straight_flush"], synergies: ["j_tribe", "j_smeared", "j_greedy", "j_droll", "j_crafty", "j_bull", "j_bootstraps"], synergy_note: "璞玉方块牌+$1，与同花体系（部落/滑稽/精明）配合打同花多方块牌收益最大化，贪婪小丑方块+3倍率同花色协同，模糊小丑扩大方块触发范围" },
        ...
        { id: "j_rocket", image: "https://patchwiki.biligame.com/images/balatro/3/34/segv2a0wf6pcd66woib9n85m6rb6imw.png", name: "火箭", rarity: "rare", type: "joker", effects: { economy: 1, economy_boss: 2 }, tags: ["economy", "boss"], description: "回合结束时获得$1，每击败1个boss盲注会这个能力获得的金钱+$2", best_with: ["all"], synergies: ["j_golden", "j_to_moon", "j_bull", "j_bootstraps"] },
        { id: "j_to_moon", image: "https://patchwiki.biligame.com/images/balatro/1/19/9awaef0twb7rgmlkjhumhoe4zmeizj4.png", name: "冲向月球", rarity: "rare", type: "joker", effects: { economy: "interest" }, tags: ["economy", "interest"], description: "回合结束时你每有$5，就获得$1的额外利息（不超过当前利息上限）", best_with: ["all"], synergies: ["j_golden", "j_rocket", "j_bull", "j_bootstraps"] },
        
        // 复制类
        { id: "j_blueprint", image: "https://patchwiki.biligame.com/images/balatro/d/d2/gapp8i1mspjudd8304lqi6je4wu9a3v.png", name: "蓝图", rarity: "legendary", type: "joker", effects: { special: "copy_right" }, tags: ["special", "copy"], description: "复制右侧小丑牌的能力", best_with: ["all"], synergies: ["j_brainstorm"] },
        { id: "j_brainstorm", image: "https://patchwiki.biligame.com/images/balatro/9/97/6td17kusye90w228dlwevrmn18lvjs7.png", name: "头脑风暴", rarity: "legendary", type: "joker", effects: { special: "copy_left" }, tags: ["special", "copy"], description: "复制最左侧小丑牌的能力", best_with: ["all"], synergies: ["j_blueprint"] },
        ...
        // 抽卡相关
        { id: "j_cartomancer", image: "https://patchwiki.biligame.com/images/balatro/d/de/ezv2labts99no53ak978lj33dqu6163.png", name: "卡牌术士", rarity: "rare", type: "joker", effects: { special: "create_tarot" }, tags: ["special", "tarot"], description: "选择盲注时，获得1张随机塔罗牌（必须有空位）", best_with: ["all"], synergies: ["j_abstract", "j_fortune_teller"] },
        ...
        { id: "j_marble", image: "https://patchwiki.biligame.com/images/balatro/5/55/dtamo4pgkn7yr5vp40a44tf2u56wxsf.png", name: "大理石小丑", rarity: "rare", type: "joker", effects: { special: "stone" }, tags: ["special", "deck"], description: "选择盲注时，增加1张石头牌到牌组中", best_with: ["all"], synergies: ["j_stone"] },
        ...
        { id: "j_steel", image: "https://patchwiki.biligame.com/images/balatro/1/15/h7xp2yhnb4mcbqk0x6932crzytaefqi.png", name: "钢铁小丑", rarity: "rare", type: "joker", effects: { xmult: "steel" }, tags: ["xmult", "steel"], description: "完整牌组内每有1张钢铁牌，这张小丑就获得×0.2倍率（起始×1倍率）", best_with: ["all"], synergies: ["t_chariot"] },
        ...
        { id: "j_supernova", image: "https://patchwiki.biligame.com/images/balatro/a/a5/rmpddv328enfhes0ucxmzfulq0jrt0s.png", name: "超新星", rarity: "common", type: "joker", effects: { mult: "hand_used" }, tags: ["mult", "scaling"], description: "将当前打出的牌型在本赛局打出的次数增加至倍率", best_with: ["all"], synergies: ["j_space"] },
        { id: "j_ride_bus", image: "https://patchwiki.biligame.com/images/balatro/8/84/j4dlq5hj5nefkc79jnjwnmk3jwtimf8.png", name: "搭乘巴士", rarity: "common", type: "joker", effects: { mult: "consecutive" }, tags: ["mult", "consecutive"], description: "连续打出没有计分的人头牌时，这张小丑获得+1倍率，失败将会重置为起始倍率（起始+0倍率）", best_with: ["all"], synergies: [] },
        ...
        { id: "j_egg", image: "https://patchwiki.biligame.com/images/balatro/f/f5/tl060oghnlfl49nb0f56mglzo0iovzc.png", name: "鸡蛋", rarity: "common", type: "joker", effects: { economy: 3 }, tags: ["economy"], description: "回合结束时，这张小丑的售价+$3", best_with: ["all"], synergies: ["j_golden", "j_to_moon", "j_bull", "j_bootstraps"] },
        { id: "j_dna", image: "https://patchwiki.biligame.com/images/balatro/f/f3/rees1v02ta0b7zyfmyu1g7xoy1sbyy8.png", name: "DNA", rarity: "legendary", type: "joker", effects: { special: "copy" }, tags: ["special", "copy"], description: "如果回合内的第1次出牌只有1张牌，则将其1张复制加入完整牌组中，并将该复制加入手牌", best_with: ["high_card"], synergies: ["j_half"], unlock: "在回合第一手只打出1张牌" },
        ...
        { id: "j_blue", image: "https://patchwiki.biligame.com/images/balatro/6/62/evw6ijpwkbdxsxy5n1tf792cxrzpkam.png", name: "蓝色小丑", rarity: "common", type: "joker", effects: { chips: "deck_remaining" }, tags: ["chips", "deck"], description: "当前牌组每有1张牌，这张小丑就获得+2筹码", best_with: ["all"], synergies: [] },
        { id: "j_sixth_sense", image: "https://patchwiki.biligame.com/images/balatro/6/65/dfl8l0fv3wxk8yxwyi3abtj9wtmbv97.png", name: "第六感", rarity: "rare", type: "joker", effects: { special: "soul" }, tags: ["special", "soul"], description: "如果回合内的第一次出牌只有1张单独的6，则将其摧毁并获得1张随机的幻灵牌（必须有空间）", best_with: ["all"], synergies: ["j_seance", "j_fortune_teller"] },
        { id: "j_hiker", image: "https://patchwiki.biligame.com/images/balatro/6/69/me7cjq9mrw2qqc04bz9993m7wjgbt19.png", name: "徒步者", rarity: "rare", type: "joker", effects: { chips: "permanent_5" }, tags: ["chips", "permanent"], description: "打出的牌在计分时永久获得+5筹码", best_with: ["all"], synergies: ["j_splash", "j_hanging_chad"], synergy_note: "飞溅让所有打出的牌计分+5筹码 | 未断选票让第1张计分牌额外触发2次，永久+15筹码" },
        ...
        { id: "j_riff_raff", image: "https://patchwiki.biligame.com/images/balatro/7/79/2fy52grw2p7b3rg7gp1c9sk49ye83wc.png", name: "乌合之众", rarity: "common", type: "joker", effects: { special: "create_joker", count: 2 }, tags: ["special", "create"], description: "选择盲注时，生成2张随机普通小丑牌", best_with: ["all"], synergies: ["j_abstract"] },
        { id: "j_vampire", image: "https://patchwiki.biligame.com/images/balatro/2/2f/eqtijo8jnuzlx7vwlx8olix8rf7y5ys.png", name: "吸血鬼", rarity: "rare", type: "joker", effects: { xmult: "augment", chance: 0.1 }, tags: ["xmult", "augment"], description: "每打出1张计分的增强游戏牌，这张小丑获得×0.1倍率，并移除游戏牌的增强效果（起始×1倍率）", best_with: ["all"], synergies: ["j_driver_license", "t_empress", "t_emperor", "j_midas"], synergy_note: "迈达斯面具持续产出金卡供吸血鬼吸收，驾驶执照需16张增强牌与吸血鬼存在取舍" },
        { id: "j_hologram", image: "https://patchwiki.biligame.com/images/balatro/6/65/84em1b6mq32h83v4s4egu9xt5u91oa2.png", name: "全息影像", rarity: "rare", type: "joker", effects: { xmult: "card_added", value: 0.25 }, tags: ["xmult", "deck"], description: "每添加1张游戏牌到你的完整牌组中，这个小丑获得×0.25倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_tarot", "j_planet"] },
        ...
        { id: "j_gift_card", image: "https://patchwiki.biligame.com/images/balatro/c/c9/dkef25sjbs1qx2vrh22kp4u8rgvvwod.png", name: "礼品卡", rarity: "rare", type: "joker", effects: { economy: "selling" }, tags: ["economy"], description: "回合结束时，使持有的小丑牌和消耗牌售价+$1", best_with: ["all"], synergies: ["j_campfire", "j_bull", "j_bootstraps"] },
        ...
        { id: "j_erosion", image: "https://patchwiki.biligame.com/images/balatro/b/b9/qm9atscbtq9q078awsd1iocsfdzq8x8.png", name: "侵蚀", rarity: "rare", type: "joker", effects: { mult: "lower_cards" }, tags: ["mult", "deck"], description: "当前的完整牌组数量每比初始的完整牌组数量少1张，这个小丑就获得+4倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_fibonacci"] },
        ...
        { id: "j_baseball", image: "https://patchwiki.biligame.com/images/balatro/b/b0/i7fuph3847pmy3clsgeyhknj5w2bzb6.png", name: "棒球卡", rarity: "legendary", type: "joker", effects: { xmult: "rare_joker", value: 1.5 }, tags: ["xmult", "rare"], description: "每张罕见小丑会给予×1.5倍率", best_with: ["all"], synergies: [] },
        ...
        { id: "j_flash", image: "https://patchwiki.biligame.com/images/balatro/0/0d/nmdc2mxq87sx1p585nj0dqd87n4baog.png", name: "抽认卡", rarity: "rare", type: "joker", effects: { mult: "reroll" }, tags: ["mult", "shop"], description: "每在商店中重掷1次，这个小丑获得+2倍率（起始+0倍率）", best_with: ["all"], synergies: ["j_chaos"] },
        ...
        { id: "j_campfire", image: "https://patchwiki.biligame.com/images/balatro/1/1a/mll86mdw41y8mu40ac4xe2cwgpzsb9w.png", name: "篝火", rarity: "legendary", type: "joker", effects: { xmult: "sell", value: 0.25 }, tags: ["xmult", "sell", "boss"], description: "每售出1张牌，这个小丑获得×0.25倍率，击败boss盲注后重置为起始倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_gift_card", "j_diet_cola"] },
        { id: "j_golden_ticket", image: "https://patchwiki.biligame.com/images/balatro/8/8e/sziabhgul1dm84fpyvo83hzdiz9linu.png", name: "黄金门票", rarity: "common", type: "joker", effects: { economy: "gold" }, tags: ["economy", "gold"], description: "打出的黄金牌在计分时获得$4", best_with: ["all"], synergies: ["j_midas", "j_bull", "j_bootstraps"] },
        ...
        { id: "j_acrobat", image: "https://patchwiki.biligame.com/images/balatro/3/35/b2m363vpkvsiyi6t067koete7i3no7m.png", name: "杂技演员", rarity: "rare", type: "joker", effects: { xmult: 3, position: "last" }, tags: ["xmult", "position"], description: "每回合的最后1次出牌，给予×3倍率", best_with: ["all"], synergies: ["j_dusk"] },
        { id: "j_swashbuckler", image: "https://patchwiki.biligame.com/images/balatro/2/2e/pq3ixa0eabrbzgvqy54xzj7870y6taw.png", name: "侠盗", rarity: "common", type: "joker", effects: { mult: "sell_value" }, tags: ["mult", "sell"], description: "将当前拥有的其他小丑的总售价增加至这个小丑的倍率", best_with: ["all"], synergies: ["j_campfire"] },
        { id: "j_troubadour", image: "https://patchwiki.biligame.com/images/balatro/e/ef/jw8tim438bd086s8t5b3apijamdl339.png", name: "游吟诗人", rarity: "rare", type: "joker", effects: { hand_size: 2, hand_size_neg: 1 }, tags: ["hand_size"], description: "+2手牌上限，-1出牌次数", best_with: ["all"], synergies: ["j_juggler", "j_turtle_bean"] },
        { id: "j_certificate", image: "https://patchwiki.biligame.com/images/balatro/b/b1/frhkys40shtjxvvf9niot44u0yodml3.png", name: "证书", rarity: "rare", type: "joker", effects: { special: "seal" }, tags: ["special", "seal"], description: "选择盲注时，增加1张带有随机蜡封的游戏牌到手牌中，并将其加入完整牌堆中", best_with: ["all"], synergies: [] },
        { id: "j_smeared", image: "https://patchwiki.biligame.com/images/balatro/e/e0/g31kfrkay37zlrscabfaste16mb066q.png", name: "模糊小丑", rarity: "rare", type: "joker", effects: { special: "suit_combine" }, tags: ["special", "suit"], description: "和视为同一花色，和视为同一花色", best_with: ["all"], synergies: ["j_greedy", "j_lusty", "j_wrathful", "j_gluttonous", "j_blackboard", "j_flower_pot", "j_ancient", "j_bloodstone", "j_arrowhead", "j_onyx", "j_rough_gem", "j_seeing_double"], synergy_note: "模糊小丑让红桃=方块、黑桃=梅花，所有指定花色的小丑触发范围翻倍" },
        ...
        { id: "j_hanging_chad", image: "https://patchwiki.biligame.com/images/balatro/0/0a/1nzxbc0wdk5alfmu9toekp1ecuyj2ve.png", name: "未断选票", rarity: "common", type: "joker", effects: { special: "first_card" }, tags: ["special", "scoring", "rescore"], description: "打出的第1张计分的牌额外触发2次", best_with: ["all"], synergies: ["j_dusk", "j_wee", "j_cavendish", "j_gros_michel", "j_fibonacci", "j_even_steven", "j_odd_todd", "j_scholar", "j_walkie", "j_hack", "j_scary_face", "j_smiley", "j_photograph", "j_greedy", "j_lusty", "j_wrathful", "j_gluttonous", "j_hiker", "j_bloodstone", "j_arrowhead", "j_onyx", "j_triboulet", "j_sock"], synergy_note: "核心能力：让第1张计分牌触发3次。所有\"打出单牌有额外计分效果\"的卡牌（点数加成、花色加成、人头牌加成等）都是天然搭档，效果翻3倍" },
        ...
        { id: "j_invisible", image: "https://patchwiki.biligame.com/images/balatro/2/26/pee9m8nbc9r9ely9iej8fw5h5gijkof.png", name: "隐形小丑", rarity: "legendary", type: "joker", effects: { special: "delayed_copy" }, tags: ["special", "copy"], description: "经过2个回合后，售出这张小丑牌会随机复制1张拥有的小丑牌（移除复制获得的小丑的负片版本）", best_with: ["all"], synergies: ["j_blueprint"] },
        { id: "j_satellite", image: "https://patchwiki.biligame.com/images/balatro/0/02/s0nxq1tk8sprjexsr15y8gi4q8ksgzm.png", name: "卫星", rarity: "rare", type: "joker", effects: { economy: "unique_planet" }, tags: ["economy", "planet"], description: "本赛局每使用过1种星球牌，回合结束时就获得$1（起始$0）", best_with: ["all"], synergies: ["j_constellation", "j_bull", "j_bootstraps"] },
        { id: "j_driver_license", image: "https://patchwiki.biligame.com/images/balatro/e/e4/t1vvh5m7j62wx1ho8nqkjj5s115yctm.png", name: "驾驶执照", rarity: "legendary", type: "joker", effects: { xmult: 3, augment_count: 16 }, tags: ["xmult", "augment"], description: "如果你的完整牌组中有16张以上的增强卡牌，则给予×3倍率", best_with: ["all"], synergies: ["j_vampire"] },
        { id: "j_astronomer", image: "https://patchwiki.biligame.com/images/balatro/6/68/cytjlep1tyb007tdx7opxxooy9uc2rb.png", name: "天文学家", rarity: "rare", type: "joker", effects: { special: "free_planet" }, tags: ["special", "planet", "shop"], description: "商店中的所有星球牌和天体补充包免费", best_with: ["all"], synergies: ["j_constellation"] },
        ...
        { id: "j_yorick", image: "https://patchwiki.biligame.com/images/balatro/f/f8/5p1lnj732ybix5gxetvztxjkmgexbpb.png", name: "约里克", rarity: "legendary", type: "joker", effects: { xmult: "discard_count", value: 1, count: 23 }, tags: ["xmult", "discard"], description: "每弃掉23张牌后，这个小丑获得×1倍率（起始×1倍率）", best_with: ["all"], synergies: ["j_burnt", "j_drunkard", "j_merry_andy"], synergy_note: "醉汉/快乐安迪增加弃牌次数，帮助快速达到23张弃牌；烧焦小丑同为弃牌流双核" },
        { id: "j_chicot", image: "https://patchwiki.biligame.com/images/balatro/1/1e/2oe6j7jntm3f18x8btzoknp8z9qa8de.png", name: "希科", rarity: "legendary", type: "joker", effects: { special: "disable_boss_all" }, tags: ["special", "boss"], description: "所有boss盲注效果消失", best_with: ["all"], synergies: ["j_luchador"] },
        { id: "j_perkeo", image: "https://patchwiki.biligame.com/images/balatro/4/48/qpmq0yj1ud1l9te7p2zoep3addx02dj.png", name: "帕奇欧", rarity: "legendary", type: "joker", effects: { special: "negative_copy" }, tags: ["special", "copy", "consumable"], description: "离开商店时，随机复制1张拥有的消耗牌，并给予其负片效果", best_with: ["all"], synergies: ["j_fortune_teller"] }
    ],
    ...
    tarots: [
        ...
        { id: "t_hanged", image: "https://static.wikia.nocookie.net/balatrogame/images/d/d6/Tarot_The_Hanged_Man.png", name: "倒吊人", effects: { destroy: "hand", count: 2 }, tags: ["destroy", "hand"], description: "永久移除最多2张牌", synergies: [] },
    ...
    spectrals: [
        ...
        { id: "s_incantation", image: "https://static.wikia.nocookie.net/balatrogame/images/6/65/Spectral_Incantation.png", name: "咒语", effects: { destroy: 1, create: "number_enhanced", count: 4 }, tags: ["spectral", "destroy", "create"], description: "摧毁1张牌，获得4张强化数字牌", synergies: [] },
        ...
        { id: "s_immolate", image: "https://static.wikia.nocookie.net/balatrogame/images/d/d8/Spectral_Immolate.png", name: "火祭", effects: { destroy: 5, economy: 20 }, tags: ["spectral", "destroy", "economy"], description: "摧毁5张牌，获得$20", synergies: [] },
        ...
        { id: "s_cryptid", image: "https://static.wikia.nocookie.net/balatrogame/images/5/5d/Spectral_Cryptid.png", name: "神秘生物", effects: { duplicate: "exact", count: 2 }, tags: ["spectral", "duplicate"], description: "选中的牌复制2份", synergies: [] },
...
const SYNERGY_RULES = {
    ...
    mime_steel: {
        cards: ["j_mime", "t_chariot"],
        name: "哑剧钢铁",
        description: "哑剧演员让手牌中钢铁牌的×1.5倍率额外触发1次，钢铁牌加成翻倍"
    },
