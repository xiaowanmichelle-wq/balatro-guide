...
const CARD_DATA = {
    ...
    jokers: [
        ...
        { id: "j_trio", image: "https://patchwiki.biligame.com/images/balatro/e/eb/4xqxpbecldizspgovlu5tdtr132ox70.png", name: "三重奏", rarity: "legendary", type: "joker", effects: { xmult: 3, hand: "three" }, tags: ["xmult", "hand"], description: "如果打出的牌包含三条，则给予×3倍率", best_with: ["three_of_a_kind"], synergies: ["j_zany"], unlock: "赢得1局游戏，且未打出三条" },
        ...
        { id: "j_onyx", image: "https://patchwiki.biligame.com/images/balatro/b/b6/j3stvd4iadcz74dpao20x7wqy4dwtd8.png", name: "缟玛瑙", rarity: "rare", type: "joker", effects: { mult: 7, suit: "clubs" }, tags: ["mult", "suit"], description: "打出的花色牌在计分时给予+7倍率", best_with: ["flush"], synergies: ["j_gluttonous", "j_blackboard", "j_smeared", "j_hanging_chad"], unlock: "牌组中拥有至少30张梅花" },
        ...
        { id: "j_driver_license", image: "https://patchwiki.biligame.com/images/balatro/e/e4/t1vvh5m7j62wx1ho8nqkjj5s115yctm.png", name: "驾驶执照", rarity: "legendary", type: "joker", effects: { xmult: 3, augment_count: 16 }, tags: ["xmult", "augment"], description: "如果你的完整牌组中有16张以上的增强卡牌，则给予×3倍率", best_with: ["all"], synergies: ["j_vampire"], unlock: "牌组中强化16张牌" },
